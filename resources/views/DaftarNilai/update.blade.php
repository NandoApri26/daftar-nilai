<div id="editJadwalKuliah" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow w-full">
            <button type="button"
                ...
                data-modal-hide="editJadwalKuliah">
            ...
            <div class="px-6 py-10">
                <h3 class="mb-10 pb-3 text-xl font-medium text-gray-900 border-b border-gray-600">Edit Jadwal Kuliah
                </h3>
                <form class="space-y-6" action="#">
                    ...
                    <div class="flex space-x-3 justify-center">
                        ...
                        <button type="submit" data-modal-hide="editJadwalKuliah" class="">
                            <h1
