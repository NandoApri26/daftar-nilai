<div id="editDosen" tabindex="-1" aria-hidden="true"
                ...
                <form class="space-y-6" action="#">
                    ...
                    <div class="flex space-x-7 justify-center">
                        ...
                        <button type="submit" data-modal-hide="editDosen" class="">
                            <h1
                                class="px-20 py-2 text-md text-amber-600 font-semibold bg-yellow-200 border border-amber-300 rounded-md hover:bg-yellow-100 ">
                                Edit Dosen</h1>
                        </button>
                    </div>
                </form>
