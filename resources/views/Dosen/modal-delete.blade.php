<div id="{{ 'hapusDosen' . $item->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-xl max-h-full">
        ...
        <div class="bg-white rounded-lg shadow w-full px-5 py-10">
            ...
            <div class="flex justify-center space-x-6 mt-5">
                <form method="POST" action="{{ url('/Dosen/' . $item->id) }}">
                    @csrf
                    @method('delete')
                ...
                <button class="" type="button" data-modal-hide="{{ 'hapusDosen' . $item->id }}">
                    <h1 aria-hidden="true"
