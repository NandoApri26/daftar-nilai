...
@section('content')
    ...
    <div class="flex space-x-3 mt-5">
        ...
        <h1 class="text-sm text-amber-600 font-bold cursor-default">Mata Kuliah</h1>
    </div>
    {{-- End Breadcrumb --}}
    ...
    <div class="flex w-full space-x-10 mt-8 justify-between">
        ...
        <div class="w-full flex justify-end space-x-3">
            ...
            <button type="button" data-modal-target="tambahMataKuliah" data-modal-toggle="tambahMataKuliah"
                ...
                <h1 class="text-sm text-amber-600 font-medium group-hover:text-amber-500">Tambah Mata Kuliah</h1>
            </button>
        ...
        <table class="w-full text-left rounded-lg overflow-hidden">
            <thead class="uppercase text-xs text-amber-600 font-bold align-top bg-yellow-200 border border-yellow-400">
                <tr class="">
                    ...
                    <th scope="col" class="px-2 py-4">Mata Kuliah (MK)</th>
                ...
                @foreach ($mataKuliah as $item)
                    <tr @class([
                        ...
                        <td class="flex flex-col px-2 py-4 space-y-2">
                            {{-- Edit --}}
                            <button type="button" data-modal-target="{{ 'editMataKuliah' . $item->id . '/edit' }}"
                                data-modal-toggle="{{ 'editMataKuliah' . $item->id . '/edit' }}"
                            ...
                            {{-- Delete --}}
                            <button type="button" data-modal-target="{{ 'hapusMataKuliah' . $item->id }}"
                                data-modal-toggle="{{ 'hapusMataKuliah' . $item->id }}"
                            ...
                            @include('MataKuliah.modal-delete')
                        </td>
                    </tr>
                @endforeach
            </tbody>
