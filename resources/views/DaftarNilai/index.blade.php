...
@section('content')
    ...
    <div class="flex space-x-3 mt-5">
        ...
        <span class="text-sm text-gray-600 font-medium cursor-default">/</span>
        <a href="">
            <h1 class="text-sm text-gray-600 font-medium">Data Mahasiswa</h1>
        </a>
        <span class="text-sm text-gray-600 font-medium cursor-default">/</span>
        <h1 class="text-sm text-amber-600 font-bold cursor-default">Daftar Nilai</h1>
    </div>
    {{-- End Breadcrumb --}}
    ...
    <div class="flex w-full space-x-10 mt-8 justify-between">
        ...
        <div class="w-full flex justify-end space-x-3">
            {{-- Start Tambah data --}}
            <button type="button" data-modal-target="tambahJadwalKuliah" data-modal-toggle="tambahJadwalKuliah"
                ...
                <h1 class="text-sm text-amber-600 font-medium group-hover:text-amber-500">Tambah Jadwal Kuliah</h1>
            </button>
            @include('DaftarNilai.create')
            {{-- End Tambah data --}}
                ...
                @for ($i = 1; $i <= 3; $i++)
                    <tr class="bg-white text-xs text-gray-600">
                        ...
                        <td class="flex flex-col px-2 py-4 space-y-2">
                            {{-- View --}}
                            {{-- <button type="button" data-modal-target="lihatDetailNilai" data-modal-toggle="lihatDetailNilai"
                            ...
                            @include('DaftarNilai.detail') --}}

                            {{-- Edit --}}
                            <button type="button" data-modal-target="editJadwalKuliah" data-modal-toggle="editJadwalKuliah"
