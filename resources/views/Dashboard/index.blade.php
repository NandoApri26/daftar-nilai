...
@section('content')
    ...
    <div class="flex gap-10">
        <div class="w-72 bg-violet-50 border border-violet-600 rounded-bl-xl rounded-tr-xl">
            ...
            <div class="bg-violet-200 border-t border-violet-600 rounded-bl-xl hover:bg-violet-300">
        ...
        <div class="w-72 bg-sky-50 border border-sky-600 rounded-bl-xl rounded-tr-xl">
            ...
            <div class="bg-sky-200 rounded-bl-xl border-t border-sky-600 hover:bg-sky-300">
                <a href="" class="flex items-center space-x-4 justify-center py-2 px-5">
                    <span class="text-gray-600 font-semibold">Info Lanjut</span>
                    <svg width="6" height="11" viewBox="0 0 6 11" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div class="w-72 bg-blue-50 border border-blue-600 rounded-bl-xl rounded-tr-xl">
            <div class="flex px-5 py-4 items-center justify-between">
                <div class="text-gray-900">
                    ...
                    <h1 class="pt-3 text-xl text-gray-900 font-medium">Program Studi</h1>
                </div>
                <div class="opacity-25">
                    <svg width="70" height="75" viewBox="0 0 20 19" fill="none">
                        <path
            ...
            <div class="bg-blue-200 rounded-bl-xl border-t border-blue-600 hover:bg-blue-300">
                <a href="" class="flex items-center space-x-4 justify-center py-2 px-5">
                    <span class="text-gray-600 font-semibold">Info Lanjut</span>
                    <svg width="6" height="11" viewBox="0 0 6 11" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
