    ...
    <div class="flex w-full space-x-10 mt-8 justify-between">
        ...
        <div class="w-full flex justify-end space-x-3">
            ...
            <button type="button" data-modal-target="tambahDosen" data-modal-toggle="tambahDosen"
                class="flex px-5 py-2 items-center space-x-3 bg-yellow-200 rounded-lg border border-amber-300 group focus:ring-0 focus:outline-none hover:bg-yellow-100">
                ...
                <h1 class="text-sm text-amber-600 font-medium group-hover:text-amber-500">Tambah Dosen</h1>
            </button>
                ...
                @foreach ($dosen as $item)
                    <tr @class([
                        ...
                        <td class="flex flex-col px-6 py-4 space-y-2">
                            {{-- View --}}
                            <button type="button" data-modal-target="{{ 'lihatDetailDosen' . $item->id }}"
                                data-modal-toggle="{{ 'lihatDetailDosen' . $item->id }}"
                            ...
                            {{-- Edit --}}
                            <button type="button" data-modal-target="{{ 'editDosen' . $item->id . '/edit' }}"
                                data-modal-toggle="{{ 'editDosen' . $item->id . '/edit' }}"
                                class="flex items-center space-x-2 group focus:ring-0 focus:outline-none">
                                <svg width="16" height="17" viewBox="0 0 20 21" fill="none">
                                    <path
